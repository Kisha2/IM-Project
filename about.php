...
<head>
  ...
  <link href="assets/img/logo.png" rel="logo1">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src=<?php echo "assets/img/profile1.jpg" ?> class="img-fluid" alt="">
          </div>
          <div class="col-lg-5 content">
            <h2><?php echo "Professional Pet Groomer in Marinduque"?></h2>
            <p class="fst-italic py-3">
            <?php echo "Kisha Mangubat has always felt a particular bond with animals. Their adventure began with a sincere passion for animals and a desire to improve their welfare. Also, she pursued in-depth training and education in the discipline of pet grooming, and consistently honed their abilities to guarantee the best care and safety for each animal customer."?>
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong><?php echo "Birthday:"?></strong> <span> <?php echo "July 2, 2003"?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong><?php echo "Website:"?></strong> <span> <?php echo "www.petgroomer.com"?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong><?php echo "Phone:"?></strong> <span> <?php echo "+63 962-0873-991"?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong><?php echo "Province:"?></strong> <span> <?php echo "Marinduque"?></span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong><?php echo "Age:"?></strong> <span> <?php echo "20"?></span></li>
            ...
            <div class="m-0">
            <?php echo "Driven by a desire to share their experiences, knowledge, and the joy that pets bring, Kisha Mangubat, along with Christel Lacerna, Mark Angelo Lazo and John Lander Pascual, launched Paws and Claws. What began as a personal journal to record their pet's achievements and adventures quickly transformed into a website dedicated to assisting other pet owners in navigating the ups and downs of pet ownership."?><br><br>
